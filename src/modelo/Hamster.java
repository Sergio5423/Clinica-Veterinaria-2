 ...
 */
public class Hamster extends Veterinaria{
    ...
    public Hamster(LocalDate fecha, long cedulaCliente, String nombreCliente, String metodoPago, double peso, String raza, String alimentacion, String razonConsulta, double precConsulta, double precVentasAd, double precCorte, double precVacunas) {
